...
HM_HEIGHT = 64
HM_WIDTH = 64
MAX = cfg.COCO_MAX_OBJECT_PER_PIC
    ...
    for i in range(7900):
        try:
            ...
            for j in range(batch_size):
                ...
                # leng = re_bbox.shape[1]
                # for ii in range(leng // 2):
                #     rect = plt.Rectangle((re_bbox[j][ii * 2][0], re_bbox[j][ii * 2][1]),
                #                          re_bbox[j][ii * 2 + 1][0] - re_bbox[j][ii * 2][0],
                #                          re_bbox[j][ii * 2 + 1][1] - re_bbox[j][ii * 2][1],
                #                          linewidth=1,
                #                          edgecolor='r',
                #                          facecolor='none')
                #
